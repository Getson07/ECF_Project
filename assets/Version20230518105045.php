...
final class Version20230518105045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS category_formula (formula_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_A0E918FFA50A6386 (formula_id), INDEX IDX_A0E918FF12469DE2 (category_id), PRIMARY KEY(formula_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
