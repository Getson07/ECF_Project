...
class ClientController extends AbstractController
{
    ...
    public function new(Request $request, ClientRepository $clientRepository,  UserPasswordHasherInterface $passwordHasher): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            {
                $this->addFlash('message', 'Mots de passes non conforme');
            ...
            $form['guests']->getData() != null ?: $client->setGuests(1);
    ...
    public function edit(Request $request, Client $client, ClientRepository $clientRepository,  UserPasswordHasherInterface $passwordHasher): Response
    {
        $form = $this->createForm(ClientType::class, $client);
        $form->handleRequest($request);
